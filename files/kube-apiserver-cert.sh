...
openssl req -new -key /var/lib/kubernetes/kubernetes.key -out /var/lib/kubernetes/kubernetes.csr -subj "/CN=kube-apiserver" -config /var/lib/kubernetes/openssl-controller.conf
